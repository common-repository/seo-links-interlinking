 ...
 * Activate the plugin.
 */
function seoli_activate() {
    add_option('seoli_do_activation_redirect', true);
}
register_activation_hook( __FILE__, 'seoli_activate' );
 ...
 */
add_filter( 'plugin_action_links_seo-links-interlinking/scdata.php', 'nc_settings_link' );
