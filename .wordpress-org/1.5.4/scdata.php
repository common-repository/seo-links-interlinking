                ...
                jQuery.ajax({
                    ...
                    <table style="margin: 8px 0;">
                        ...
                        <tr>
                            ...
                            <th scope="row" onclick="sortTable('seo_links_keyword', 1)" style="cursor: pointer;">Impressions</th>
                        </tr>
                        </thead>
                        <tbody>`;
                     ...
                     <input type="text" id="seo_links_most_relevant_keyword_input" onkeyup="keywordResearch('seo_links_most_relevant_keyword')" placeholder="Search for keyword.." style="margin-top: 16px;width: 100%;" />
                        <table style="margin: 8px 0;">
                            ...
                            <tr>
                                ...
                                <th scope="row" onclick="sortTable('seo_links_most_relevant_keyword', 1)" style="cursor: pointer;">Impressions</th>
                            </tr>
                            </thead>
                            <tbody>`;
