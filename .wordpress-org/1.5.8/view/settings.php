...
<?php if(isset($_SESSION['seoli_status']) && (sanitize_text_field( $_SESSION['seoli_status'] ) == 0 || sanitize_text_field( $_SESSION['seoli_status'] == 1) ) ) : ?>
    <div class="notice notice-success is-dismissible">
        <p><?php echo esc_html( $_SESSION['seoli_message'] ); ?></p>
    </div>
<?php endif; ?>
...
<?php endif; ?>
<?php $seoli_user_display_name = get_option( 'seoli_user_display_name' ); ?>

<?php if( !empty( $seoli_user_display_name ) ) : ?>
    <div style="width: 100%;float: left;margin-bottom: 24px;">
        <div style="float: left;">
            <h4>Hi, <?php echo esc_html( $seoli_user_display_name ); ?></h4>
        </div>
        <div style="float: right;padding: 15px 10px;">
            <form method="POST" action="<?php echo admin_url( 'admin-post.php'); ?>">
                <input name="action" type="hidden" value="seoli_logout_form_submit">
                <button type="submit" class="button button-primary" onclick="seoli_logout();">Logout</button>
            </form>
        </div>
    </div>
    <form method="POST" action="options.php">
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    <input name="sc_api_key" type="text" id="sc_api_key" class="regular-text" value="<?php echo esc_html( ( isset( $_SESSION['seoli_status'] ) && sanitize_text_field( $_SESSION['seoli_status'] ) == 0 ) ? ( $_SESSION['seoli_api_key'] ?? get_option( 'sc_api_key' ) ) : get_option( 'sc_api_key' ) ); ?>">
        ...
        <div style="width: 48%;float:left">
            <form action="<?php echo admin_url('admin-post.php'); ?>" method="post">
                ...
                <table class="form-table">
                    ...
                    <?php if(isset($_SESSION['seoli_status']) &&  sanitize_text_field( $_SESSION['seoli_status'] ) == -1) : ?>
                        <tr>
                            <td colspan="2">
                                <div class="notice notice-error is-dismissible"><p><?php echo esc_html( $_SESSION['seoli_message'] ); ?></p></div>
                            </td>
                        </tr>
                    <?php endif; ?>
                    <?php if(isset($_SESSION['seoli_status']) && sanitize_text_field( $_SESSION['seoli_status'] ) == 1) : ?>
                        <tr>
                            <td colspan="2">
                                <div class="notice notice-success is-dismissible"><p><?php echo esc_html( $_SESSION['seoli_message'] ); ?></p></div>
                            </td>
                        </tr>
                    <?php endif; ?>
                    <tr>
        ...
        <div style="width: 48%;float:right">
            <form action="<?php echo admin_url('admin-post.php'); ?>" method="post">
                ...
                <table class="form-table">
                    ...
                    <?php if(isset($_SESSION['seoli_status']) && sanitize_text_field( $_SESSION['seoli_status'] ) == -10) : ?>
                        <tr>
                            <td colspan="2">
                                <div class="notice notice-error is-dismissible"><p><?php echo esc_html( $_SESSION['seoli_message'] ); ?></p></div>
                            </td>
                    ...
                    <?php endif; ?>
                    <?php if(isset($_SESSION['seoli_status']) && sanitize_text_field( $_SESSION['seoli_status'] ) == 0) : ?>
                        <tr>
                            <td colspan="2">
                                <div class="notice notice-success is-dismissible"><p><?php echo esc_html( $_SESSION['seoli_message'] ); ?></p></div>
                            </td>
...
<?php
unset( $_SESSION['seoli_status'] );
unset( $_SESSION['seoli_message'] );
unset( $_SESSION['seoli_api_key'] );
